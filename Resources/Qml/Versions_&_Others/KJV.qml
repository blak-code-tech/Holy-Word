    ...
    Keys.onPressed: {
        if (event.key === Qt.Key_Right) {
            ...
            if ((chapter.currentIndex + 1) < chap_) {
                ...
                bible.bible_text_kjv(book.currentIndex,
        ...
        if (event.key === Qt.Key_Up) {
            ...
            if ((verse.currentIndex + 1) < verse_) {
                bible.bible_text_kjv(book.currentIndex, chapter.currentIndex,
                ...
                ComboBox {
                    ...
                    onActivated: {
                        ...
                        bible.bible_text_kjv(book.currentIndex,
                                             chapter.currentIndex,
                                             verse.currentIndex)
                        if (change_to_niv.checked === true) {
                            bible.bible_text_niv(book.currentIndex,
                                                 chapter.currentIndex,
                                                 verse.currentIndex)
                        }
                ...
                Rectangle {
                    ...
                    Button {
                        ...
                        onClicked: {
                            ...
                            say.speak_chapter_kjv(book.currentIndex,
                                                  chapter.currentIndex)
                        }
                    }
                    Button {
                        ...
                        onClicked: {
                            ...
                            say.speak_verse_kjv(book.currentIndex,
                                                chapter.currentIndex,
                                                verse.currentIndex)
                        }
                    }
                    ...
                    Button {
                        ...
                        onClicked: {
                            bible.random_verse()
                            bible.chapter_list(book.currentIndex = a)
                            bible.verse_list(book.currentIndex = a,
                                             chapter.currentIndex = b)

                            bible.bible_text_kjv(book.currentIndex = a,
                                                 chapter.currentIndex = b,
                                                 verse.currentIndex = c)
                            if (change_to_niv.checked === true) {
                                bible.bible_text_niv(book.currentIndex = a,
                                                     chapter.currentIndex = b,
                                                     verse.currentIndex = c)
                            }
                            if ((chapter.currentIndex + 1) > 0) {
                    ...
                    Button {
                        ...
                        anchors.left: parent.left
                        ToolTip.visible: hovered
                        ToolTip.text: qsTr("Random verse")
                    ...
                    Button {
                        ...
                        checkable: true
                        contentItem: Text {
                            text: change_to_niv.text
                            font: change_to_niv.font
                            opacity: enabled ? 1.0 : 0.3
                            horizontalAlignment: Text.AlignHCenter
                            verticalAlignment: Text.AlignVCenter
                            elide: Text.ElideRight
                        ...
                        background: Rectangle {
                            ...
                            opacity: enabled ? 1 : 0.3
                            border.color: {
                                change_to_niv.down ? "#c0c0c0" : "#80c0c0c0"
                                change_to_niv.hovered ? "#c0c0c0" : "#80c0c0c0"
                            }
                            border.width: 2
                            radius: 5
                        }
                        onClicked: {
                            if (change_to_niv.checked === true) {
                                ...
                                bible.bible_text_niv(book.currentIndex,
                                                     chapter.currentIndex,
                                                     verse.currentIndex)
                            } else if (change_to_niv.checked === false) {
                                two.visible = false
                                one.visible = true
                            }
                        }
