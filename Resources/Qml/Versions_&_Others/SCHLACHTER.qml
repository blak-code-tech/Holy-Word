    ...
    Keys.onPressed: {
        if (event.key === Qt.Key_Right) {
            ...
            if ((chapter.currentIndex + 1) < chap_) {
                ...
                bible.bible_text_ger(book.currentIndex,
        ...
        if (event.key === Qt.Key_Up) {
            ...
            if ((verse.currentIndex + 1) < verse_) {
                bible.bible_text_apee(book.currentIndex, chapter.currentIndex,
        ...
        if (event.key === Qt.Key_Down) {
            if (verse.currentIndex > 0) {
                bible.bible_text_ger(book.currentIndex, chapter.currentIndex,
                                     verse.currentIndex -= 1)
            }
